...
"""%s
 ...
 - author      : Wanz X Black
 - facebook    : facebook.com/Wanzstore11
 - fanspage    : facebook.com/Wanzstore11
 - whatsap     : +62895604375364
 - github      : github.com/Wandybchtr
 - script name : SIMPLEV2
 - version     : 1.8
 
  - author      : Wanz X Black
 - facebook    : facebook.com/Wanzstore11
 - whatsap     : +62 895604375364
 - github      : github.com/wandybchtr
 - script name : SIMPLEV2 
 - version     : 1.8
...
| Jika Ada Yang Eror Anda Bisa Mengubungi Mr.Wanz X Black. |
...
def menu():
    ...
    kotak()
#    banner()
    print (' %s[∆] Auhtor   : Wanzz X black'%(P))
    print (' [∆] gh auhtor : https://github.com/Wandybchtr')
    print (' [∆] gh auhtor : https://Facebook.com/Wanzstore11')
    print (jembut)
...
def peweh():
    with WanzGanteng(max_workers=30) as (__WanzXD__):
        for yntkts in yan:
            try:
